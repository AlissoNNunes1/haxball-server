...
function getRealSoccerMap(map) {
	map = {
		...
		"vertexes" : [
			...
			/* 32 */ { "x" : 1569.3106669157482, "y" : 840.7021429905794, "bCoef" : -2.9, "cMask" : ["ball" ], "cGroup" : ["c0" ], "trait" : "line" },
			/* 33 */ { "x" : 1610, "y" : 798.6670358410504, "bCoef" : -2.9, "cMask" : ["ball" ], "cGroup" : ["c0" ], "trait" : "line" },
			/* 34 */ { "x" : 1610, "y" : -798.6670358410504, "bCoef" : -2.9, "cMask" : ["ball" ], "cGroup" : ["c0" ], "trait" : "line" },
			/* 35 */ { "x" : 1569.3106669157482, "y" : -840.7021429905794, "bCoef" : -2.9, "cMask" : ["ball" ], "cGroup" : ["c0" ], "trait" : "line" },
			
			/* 36 */ { "x" : 0, "y" : 252.2106428971738, "bCoef" : 0.1, "cMask" : ["red","blue" ], "cGroup" : ["blueKO" ], "trait" : "kickOffBarrier", "curve" : -180 },
			/* 37 */ { "x" : 0, "y" : -252.2106428971738, "bCoef" : 0.1, "cMask" : ["red","blue" ], "cGroup" : ["redKO" ], "trait" : "kickOffBarrier", "curve" : 180 },
			/* 38 */ { "x" : 0, "y" : 252.2106428971738, "bCoef" : 0.1, "cMask" : ["red","blue" ], "cGroup" : ["redKO" ], "trait" : "kickOffBarrier", "curve" : 180 },
			
			/* 39 */ { "x" : -1443.2053454671614, "y" : -56.046809532705296, "bCoef" : -5.7, "cMask" : ["ball" ], "cGroup" : ["c0" ], "trait" : "line", "curve" : 70, "color" : "576C46", "vis" : false },
			/* 40 */ { "x" : -1443.2053454671614, "y" : 56.046809532705296, "bCoef" : -5.7, "cMask" : ["ball" ], "cGroup" : ["c0" ], "trait" : "line", "curve" : 70, "color" : "576C46", "vis" : false },
			/* 41 */ { "x" : 1443.2053454671614, "y" : -56.046809532705296, "bCoef" : -5.7, "cMask" : ["ball" ], "cGroup" : ["c0" ], "trait" : "line", "curve" : -70, "color" : "576C46", "vis" : false },
			/* 42 */ { "x" : 1443.2053454671614, "y" : 56.046809532705296, "bCoef" : -5.7, "cMask" : ["ball" ], "cGroup" : ["c0" ], "trait" : "line", "curve" : -70, "color" : "576C46", "vis" : false },
			...
			/* 49 */ { "x" : -1821.521309812922, "y" : -700, "bCoef" : 0, "cMask" : ["c1" ], "cGroup" : ["red","blue" ], "color" : "ec644b", "vis" : false },
			/* 50 */ { "x" : 1821.521309812922, "y" : -700, "bCoef" : 0, "cMask" : ["c1" ], "cGroup" : ["red","blue" ], "color" : "ec644b", "vis" : false },
			/* 51 */ { "x" : -1821.521309812922, "y" : 700, "bCoef" : 0, "cMask" : ["c1" ], "cGroup" : ["red","blue" ], "color" : "ec644b", "vis" : false },
			/* 52 */ { "x" : 1821.521309812922, "y" : 700, "bCoef" : 0, "cMask" : ["c1" ], "cGroup" : ["red","blue" ], "color" : "ec644b", "vis" : false },
			/* 53 */ { "x" : -1814.515458621334, "y" : -448.37447626164237, "cMask" : ["c0" ], "cGroup" : ["red","blue" ] },
			/* 54 */ { "x" : -1176.983000186811, "y" : -448.37447626164237, "cMask" : ["c0" ], "cGroup" : ["red","blue" ] },
			/* 55 */ { "x" : -1176.983000186811, "y" : 448.37447626164237, "cMask" : ["c0" ], "cGroup" : ["red","blue" ] },
			/* 56 */ { "x" : -1814.515458621334, "y" : 448.37447626164237, "cMask" : ["c0" ], "cGroup" : ["red","blue" ] },
			/* 57 */ { "x" : 1814.515458621334, "y" : -448.37447626164237, "cMask" : ["c0" ], "cGroup" : ["red","blue" ] },
			/* 58 */ { "x" : 1176.983000186811, "y" : -448.37447626164237, "cMask" : ["c0" ], "cGroup" : ["red","blue" ] },
			/* 59 */ { "x" : 1176.983000186811, "y" : 448.37447626164237, "cMask" : ["c0" ], "cGroup" : ["red","blue" ] },
			/* 60 */ { "x" : 1814.515458621334, "y" : 448.37447626164237, "cMask" : ["c0" ], "cGroup" : ["red","blue" ] },
		...
		"segments" : [
			...
			{ "v0" : 49, "v1" : 50, "vis" : false, "color" : "ec644b", "bCoef" : 0, "cMask" : ["c1" ], "cGroup" : ["red","blue" ], "y" : -700 },
			{ "v0" : 51, "v1" : 52, "vis" : false, "color" : "ec644b", "bCoef" : 0, "cMask" : ["c1" ], "cGroup" : ["red","blue" ], "y" : 700 },
			...
			{ "v0" : 64, "v1" : 62, "curve" : 5, "color" : "FFFFFF", "bCoef" : 0.1, "cMask" : ["ball","red","blue" ], "bias" : 0, "x" : -1690 },
			...
			{ "v0" : 68, "v1" : 70, "curve" : -5, "color" : "FFFFFF", "bCoef" : 0.1, "cMask" : ["ball","red","blue" ], "x" : 1690 },
		...
		"discs" : [
			{ "radius" : 0, "invMass" : 0, "pos" : [-1836.934182434416,-26.622234528035015 ], "color" : "ffffffff", "bCoef" : 0, "cMask" : ["red" ], "cGroup" : ["ball" ] },
			{ "radius" : 0, "invMass" : 0, "pos" : [-1835.5330121960983,40.633936911211336 ], "color" : "ffffffff", "bCoef" : 0, "cMask" : ["blue" ], "cGroup" : ["ball" ] },
			{ "radius" : 0, "invMass" : 0, "pos" : [-1832.730671719463,86.8725547756932 ], "color" : "ffffffff", "bCoef" : 0, "cMask" : ["red","blue" ], "cGroup" : ["ball" ] },
			
			{ "radius" : 3.7831596434576076, "pos" : [-1610,840 ], "cGroup" : ["ball" ], "trait" : "cornerflag" },
			{ "radius" : 3.7831596434576076, "pos" : [1610,-840.7021429905794 ], "cGroup" : ["ball" ], "trait" : "cornerflag" },
			{ "radius" : 3.7831596434576076, "pos" : [1610,840.7021429905794 ], "cGroup" : ["ball" ], "trait" : "cornerflag" },
			
			{ "radius" : 6.21048543178578, "invMass" : 0, "pos" : [-1610,-150 ], "bCoef" : 0.5, "trait" : "goalPost", "x" : -1610 },
			{ "radius" : 6.21048543178578, "invMass" : 0, "pos" : [-1610,150 ], "bCoef" : 0.5, "trait" : "goalPost", "x" : -1610 },
			{ "radius" : 2.4841941727143118, "invMass" : 0, "pos" : [-1740,-196 ], "color" : "000000", "bCoef" : 1, "trait" : "goalPost", "x" : -1740, "y" : -196 },
			{ "radius" : 2.4841941727143118, "invMass" : 0, "pos" : [-1740,196 ], "color" : "000000", "bCoef" : 1, "trait" : "goalPost", "y" : 196, "x" : -1740 },
			{ "radius" : 7.005851191588162, "invMass" : 0, "pos" : [1610,-150 ], "bCoef" : 0.5, "trait" : "goalPost" },
			{ "radius" : 7.005851191588162, "invMass" : 0, "pos" : [1610,150 ], "bCoef" : 0.5, "trait" : "goalPost", "x" : 1610 },
			{ "radius" : 2.8023404766352646, "invMass" : 0, "pos" : [1751.4627978970404,-221.38489765418592 ], "color" : "000000", "bCoef" : 1, "trait" : "goalPost" },
			{ "radius" : 2.8023404766352646, "invMass" : 0, "pos" : [1751.4627978970404,221.38489765418592 ], "color" : "000000", "bCoef" : 1, "trait" : "goalPost" },
...
room.onPlayerJoin = function(player) {	
	...
	whisper("Olá, seja bem vindo a CIRS! Um servidor de Real Soccer", player.id, 0x61ddff, "bold", 0);
		...
		if (byPlayer == null) {
			...
			if (choosePositionMode) {
				...
				for (const player of players) {
					announce(`Posições disponíveis: ${getAvailablePositions(player.team).join(', ')}`, player.id);
				}
			}
		}
		else {
...
let gamePaused = false, unpauseTimeout;
...
let offsidePlayersIDs = [], playersPosOnOffside = {}, ballPosOnOffside = {}, _2ndLastDefenderID, handlingOffside = false;
	...
	if (!handlingOffside) {
		if (offsidePlayersIDs.includes(player.id)) {
			...
			for (const playerId in playersPosOnOffside) {
				room.setPlayerDiscProperties(playerId, { ...playersPosOnOffside[playerId], xspeed: 0, yspeed: 0, invMass: 9999999});
			}
			if (player.team == 1 && ballPosOnOffside.x > playersPosOnOffside[_2ndLastDefenderID].x || player.team == 2 && ballPosOnOffside.x < playersPosOnOffside[_2ndLastDefenderID].x) {
				room.setDiscProperties(16, { x: player.team == 1 ? ballPosOnOffside.x+8.25 : ballPosOnOffside.x-8.25, y: fieldHeightLimit });
				room.setDiscProperties(17, { x: player.team == 1 ? ballPosOnOffside.x+8.25 : ballPosOnOffside.x-8.25, y: -fieldHeightLimit });
				room.setDiscProperties(18, { x: player.team == 1 ? playersPosOnOffside[player.id].x+15 : playersPosOnOffside[player.id].x-15, y: fieldHeightLimit});
				room.setDiscProperties(19, { x: player.team == 1 ? playersPosOnOffside[player.id].x+15 : playersPosOnOffside[player.id].x-15, y: -fieldHeightLimit });
			} else {
				room.setDiscProperties(16, { x: player.team == 1 ? playersPosOnOffside[_2ndLastDefenderID].x+15 : playersPosOnOffside[_2ndLastDefenderID].x-15, y: fieldHeightLimit });
				room.setDiscProperties(17, { x: player.team == 1 ? playersPosOnOffside[_2ndLastDefenderID].x+15 : playersPosOnOffside[_2ndLastDefenderID].x-15, y: -fieldHeightLimit });
				room.setDiscProperties(18, { x: player.team == 1 ? playersPosOnOffside[player.id].x+15 : playersPosOnOffside[player.id].x-15, y: fieldHeightLimit});
				room.setDiscProperties(19, { x: player.team == 1 ? playersPosOnOffside[player.id].x+15 : playersPosOnOffside[player.id].x-15, y: -fieldHeightLimit });
				room.setDiscProperties(0, { xspeed: 0, yspeed: 0, xgravity: 0, ygravity: 0, x: ballPosOnOffside.x, y: ballPosOnOffside.y });
			}
			room.setDiscProperties(0, { xspeed: 0, yspeed: 0, xgravity: 0, ygravity: 0, x: ballPosOnOffside.x, y: ballPosOnOffside.y });
			room.sendAnnouncement(`${player.name} não estava em posição legal. Impedimento marcado!`);
			await sleep(3000).then(() => {
				...
				room.setPlayerDiscProperties(player.id, { x: player.team == 1 ? playersPosOnOffside[player.id].x-35 : playersPosOnOffside[player.id].x+35 });
				room.setDiscProperties(0, { xspeed: 0, yspeed: 0, x: playersPosOnOffside[player.id].x, y: playersPosOnOffside[player.id].y });
				room.setDiscProperties(3, { x: playersPosOnOffside[player.id].x, y: playersPosOnOffside[player.id].y, radius: 18 });
				room.setDiscProperties(player.team == 1 ? 1 : 2, { x: playersPosOnOffside[player.id].x, y: playersPosOnOffside[player.id].y, radius: 210 });
			});
			playersPosOnOffside = {};
			ballPosOnOffside = {};
			...
			if (shouldCheckOffside(player)) {
				...
				if (redPlayers.length > 1 && bluePlayers.length > 1) {
					player.team == 1 ? bluePlayers.sort((a, b) => a.position.x - b.position.x) : redPlayers.sort((a, b) => b.position.x - a.position.x);
					const _2ndLastDefender = player.team == 1 ? bluePlayers[bluePlayers.length-2] : redPlayers[redPlayers.length-2];
					_2ndLastDefenderID = _2ndLastDefender.id;
					const offsidePlayers = player.team == 1 ? 
						redPlayers.filter(p => 
							p.id !== player.id && p.position.x > -15 && p.position.x > _2ndLastDefender.position.x && p.position.x > ballPosition.x
						) : bluePlayers.filter(p => 
							p.id !== player.id && p.position.x < 15 && p.position.x < _2ndLastDefender.position.x && p.position.x < ballPosition.x
						);
...
room.onPlayerBallKick = function(player) {
	if (map == "RSR") {
		...
		if (game.rsActive == false && game.rsReady == true) { // make game active on kick from CK/GK
			if ((game.rsCorner == true || game.rsGoalKick == true)) {
				...
				game.ballInAir = true;
				sleep(2000).then(() => { // tempo até que a bola volte a colidir com os jogadores
...
room.onPlayerChat = function(player, message) {
	if (message.startsWith('!formacao red ') && player.admin) {
        const formation = message.substr(14).trim().toLowerCase(); // Extrai o nome da formação do comando
        changeFormation(player, formation, 1);
        return false;
    }

	else if (message.startsWith('!formacao blue ') && player.admin) {
        const formation = message.substr(15).trim().toLowerCase(); // Extrai o nome da formação do comando
        changeFormation(player, formation, 2);
        return false;
    }

	if ((choosePositionMode && !message.startsWith('')) || (sala_mutada && !player.admin)) return false;
	...
	if (message.startsWith("!")) {
		...
		if (Object.keys(positions[activeFormation]).includes(args[0].toUpperCase()) && player.team !== 0) {
			const position = args[0].toUpperCase();
			if (choosePositionMode) {
				setPlayerPosition(player, player.team, position);
			}
		}
		else if (args[0] == 'rpos' && player.team !== 0) {
			if (choosePositionMode)
		...
		else if (args[0] == "admin" && args.length == 1 && allowPublicAdmin == true) {
		...
		else if (args[0] == "penal" && ["red", "v"].includes(args[1]) && player.admin) {
			game.rsActive = false;
			game.rsReady = true;
			game.rsPenalty = true;
			...
			room.setDiscProperties(0, {invMass: 1.8, x: penalMark, y: 0, xspeed: 0, yspeed: 0, color: "0xff3f34", xgravity: 0, ygravity: 0});
			room.sendAnnouncement('Pênalti para o red!');
			/*sleep(5000).then(() => {
				room.setDiscProperties(3, {x: 0, y: 2000, radius: 0});
			});*/
		}
		else if (args[0] == "penal" && ["blue", "a"].includes(args[1]) && player.admin) {
			game.rsActive = false;
			game.rsReady = true;
			game.rsPenalty = true;
			const players = room.getPlayerList().filter((player) => player.team != 0);
			...
			room.setDiscProperties(3, {x: -penalMark, y: 0, radius: 18 });
			room.setDiscProperties(0, {invMass: 1.8, x: -penalMark, y: 0, xspeed: 0, yspeed: 0, color: "0x0fbcf9", xgravity: 0, ygravity: 0});
			room.sendAnnouncement('Pênalti para o blue!')
			/*sleep(5000).then(() => {
				room.setDiscProperties(3, {x: 0, y: 2000, radius: 0});
			});*/
		}
		else if (args[0] == "falta" && ["red", "v"].includes(args[1]) && player.admin) {
			game.rsActive = false;
			game.rsReady = true;
			game.rsFoul = true;
			const players = room.getPlayerList().filter((player) => player.team != 0);
			...
			room.setDiscProperties(0, { invMass: 1.05, x: ballPosition.x, y: ballPosition.y, xspeed: 0, yspeed: 0, color: "0xffffff", xgravity: 0, ygravity: 0 });
			room.sendAnnouncement('Falta para o red!');
		}
		else if (args[0] == "falta" && ["blue", "a"].includes(args[1]) && player.admin) {
			game.rsActive = false;
			game.rsReady = true;
			game.rsFoul = true;
			const players = room.getPlayerList().filter((player) => player.team != 0);
			...
			room.sendAnnouncement("Link do discord:Discord CIRS: https://discord.gg/mWzatsxjTA | Discord Parceiros: https://discord.gg/mWzatsxjTA ", player.id, verde, "bold", 1)
		}
		return false;
	}
			...
			if (args.length > 1) {
				...
				players.forEach(function(pmPlayer) {
					if (pmPlayer.name === args[0] || pmPlayer.name === args[0].replace(/_/g, ' ')) {
						whisper("[PM > " + pmPlayer.name + "] " + player.name + ": " + pmMsg, player.id, 0xffa220, "normal", 1);	
...
function displayHelp(id, selection) {
	if (selection == null) {
		whisper("Commands: @@[mensagens no privado de alguém, ex: @@urugay[mensagem]], !rs, !rr, !bb, !powershot, !ps, !admin, !setpassword, !clearpassword, !super, !clearbans, !swap, t [team chat msg], !court, !court [hexcolor], !court reset", id, null, "small");
	}
}
...
for (const position in positions.red) {
    positions.blue[position] = {...positions.red[position], x: -positions.red[position].x, y: -positions.red[position].y};
}

let activeFormation_red = 'red';
let activeFormation_blue = 'blue';
let choosePositionMode = false, teamPositions = {
	1: {...positions.red},
	2: {...positions.blue}
}, playersPositions = {};
...
function updateChoosePositionMode() {
    ...
    if (room.getScores() !== null) {
        ...
        console.log("Players without position:", playersWithoutPosition.map(p => p.name));
...
async function setPlayerPosition(player, team, position) {
    if (isPositionAvailable(team, position)) {
        if (playersPositions[player.id]) {
            teamPositions[team][playersPositions[player.id]] = positions[team == 1 ? 'red' : 'blue'][playersPositions[player.id]];
        }
        ...
        position == 'GK' ? room.setPlayerDiscProperties(player.id, teamPositions[team][position]) :
        ...
        room.sendAnnouncement(`A posição ${position} não está disponível no seu time.\nPosições disponíveis: ${getAvailablePositions(team).join(', ')}`, player.id);
    }
}
...
function getAvailablePositions(team) {
    ...
    return Object.keys(positions[activeFormation]).filter(position => teamPositions[team][position]);
}
...
function positionThePlayers() {
    ...
    if (redPlayers.length == 7) {
        for (const player of redPlayers) {
            ...
            playerPosition == 'GK' ? room.setPlayerDiscProperties(player.id, positions.red[playerPosition]) :
    ...
    if (bluePlayers.length == 7) {
        for (const player of bluePlayers) {
            ...
            if (!playerPosition) continue;
            console.log(`Setting position for ${player.name} to ${playerPosition}`);
            playerPosition == 'GK' ? room.setPlayerDiscProperties(player.id, positions.blue[playerPosition]) :
            room.setPlayerDiscProperties(player.id, {...positions.blue[playerPosition], radius: 15});
        }
    }
}
	...
	if (map == "RSR") {
		if (room.getScores() != null) {
			...
			if (choosePositionMode && changedPlayer.team !== 0)
				announce(`Posições disponíveis: ${getAvailablePositions(changedPlayer.team).join(', ')}`, changedPlayer.id);
			if (game.rsActive == false) {
				if (game.rsGoalKick == true || game.rsCorner == true || game.rsFoul == true ||game.rsPenalty == true) {
...
room.onTeamGoal = function(team) {
	if (map == "RSR") {
		...
		announce(goalType + " Vermelho " + game.redScore + " - " + game.blueScore + " Azul ¦¦ Marcado aos " + goalTime + " " + scorer + assister);
...
function realSoccerRef() {
	...
	if (game.rsActive == true) {
		if ((room.getBallPosition().y > fieldHeightLimit || room.getBallPosition().y < -fieldHeightLimit)) {
			game.rsActive = false;
			if (game.lastPlayAnnounced == true) {
				room.pauseGame(true);
				game.lastPlayAnnounced = false;
		...
		if (room.getBallPosition().x > goalsCoord[0] && (room.getBallPosition().y > goalsCoord[1] || room.getBallPosition().y < -goalsCoord[1])) {
			game.rsActive = false;	
			if (game.lastPlayAnnounced == true) {
				room.pauseGame(true);
				game.lastPlayAnnounced = false;
			...
			if (game.rsTouchTeam == 1) {				
				...
				sleep(100).then(() => {					
					...
					game.boosterCount = 0;
					game.boosterState = false;
					room.setDiscProperties(0, {invMass: goalKickStrength, xspeed: 0, yspeed: 0, x: goalKickCoord, y: 0, color: "0x0fbcf9", cMask: 268435519, xgravity: 0, ygravity: 0});
				});
				sleep(3000).then(() => {
					room.setDiscProperties(3, {x: 0, y: 2000, radius: 0});
				});
				...
				if (room.getBallPosition().y < -goalsCoord[1]) {					
					...
					sleep(100).then(() => {
						...
						game.boosterCount = 0;
						game.boosterState = false;
						room.setDiscProperties(0, {invMass: cornerKickStrength, x: cornerKickCoord[0], y: -cornerKickCoord[1], xspeed: 0, yspeed: 0, color: "0xff3f34", cMask: 268435519, xgravity: 0, ygravity: 0});
						room.setDiscProperties(2, {x: (cornerKickCoord[0] + 10), y: -(cornerKickCoord[1] + 70), radius: 600 });
						room.setDiscProperties(3, {x: 0, y: 2000, radius: 0});
					});
				}
				if (room.getBallPosition().y > goalsCoord[1]) {
			...
			if (game.rsTouchTeam == 1) {				
				...
				if (room.getBallPosition().y < -goalsCoord[1]) {
					...
					sleep(100).then(() => {
						...
						game.boosterCount = 0;
						game.boosterState = false;
						room.setDiscProperties(0, {invMass: cornerKickStrength, x: -cornerKickCoord[0], y: -cornerKickCoord[1], xspeed: 0, yspeed: 0, color: "0x0fbcf9", cMask: 268435519, xgravity: 0, ygravity: 0});
						room.setDiscProperties(1, {x: -(cornerKickCoord[0] + 10), y: -(cornerKickCoord[1] + 70), radius: 600 });
						room.setDiscProperties(3, {x: 0, y: 2000, radius: 0});
					});	
				}
				if (room.getBallPosition().y > goalsCoord[1]) {
				...
				sleep(100).then(() => {
					...
					game.boosterCount = 0;
					game.boosterState = false;
					room.setDiscProperties(0, {invMass: goalKickStrength, xspeed: 0, yspeed: 0, x: -goalKickCoord, y: 0, color: "0xff3f34", cMask: 268435519, xgravity: 0, ygravity: 0});
				});
				sleep(3000).then(() => {
					room.setDiscProperties(3, {x: 0, y: 2000, radius: 0});
				});
...
function handleBallTouch() {
	...
	for (var i = 0; i < players.length; i++) { // Iterate over all the players
		...
		if ( distanceToBall < triggerDistance ) {	
			...
			//=========== POWERSHOT CODE ===========
			if (game.rsCorner == false && game.rsGoalKick == false && powerShotMode == true && !game.ballInAir) {
				...
				if (game.powershotID != player.id) {
					...
					if (game.touchTrigger) {
						if (game.outStatus == "redThrow" || game.outStatus == "blueThrow") {
							...
							room.setDiscProperties(0, {invMass: 1.5, color: "0xffe600"});
						} else if (ballColor == "0xffe600" || ballColor == "0xff0000" || ballColor == "0x007fff") {
					...
					if (game.outStatus !== "redThrow" && game.outStatus !== "blueThrow") {
						if (ballColor == "0xffffff") {
							...
							if (game.powershotCounter >= 100 && game.powershotTrigger == false && room.getDiscProperties(0).invMass != 2.2) {
							...
							game.powershotCounter++;
							if (game.powershotCounter >= 100 && game.powershotTrigger == false && room.getDiscProperties(0).invMass != 2.8) {
		...
		//=========== POWERSHOT CODE ===========
		if ( distanceToBall > triggerDistance +3 && player.id == game.powershotID && (game.powershotTrigger || !game.touchTrigger) && powerShotMode == true) {
			game.powershotID = 0;
	...
	if (room.getBallPosition().y > 0) { // bottom throw line
		if (game.outStatus == "redThrow") {
			players.forEach(function(player) {
				...
				if (room.getDiscProperties(21).x != fieldWidth - 1) { // show bottom red line
					room.setDiscProperties(21, {x: fieldWidth - 1});
				}
				if (room.getDiscProperties(23).x != -(fieldWidth - 1)) { // hide bottom blue line
		...
		if (game.outStatus == "blueThrow") {
			players.forEach(function(player) {
				...
				if (room.getDiscProperties(23).x != fieldWidth - 1) { // show bottom blue line
					room.setDiscProperties(23, {x: fieldWidth - 1});
				}
				if (room.getDiscProperties(21).x != -(fieldWidth - 1)) { // hide bottom red line
					room.setDiscProperties(21, {x: -(fieldWidth - 1)});
				}
			});
		}		
		...
		if (game.outStatus == "redGK") {
			players.forEach(function(player) {
				if (player.team == 2 && room.getPlayerDiscProperties(player.id).x < 0) {
					...
					if (player.position.x < -penalArea[0] && player.position.y > -penalArea[1] && player.position.y < penalArea[1]) {
...
function anuncio()
{
    room.sendAnnouncement("Discord CIRS: https://discord.gg/mWzatsxjTA", null, azul, "bold", 0);
}
