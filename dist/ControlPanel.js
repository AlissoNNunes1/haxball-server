    ...
    async command(msg) {
        ...
        if (command === 'help') {
            embed
                ...
                .addFields({ name: 'help', value: 'Command list.', inline: true }, { name: 'info', value: 'Server info.', inline: true }, { name: 'meminfo', value: 'CPU and memory info.', inline: true }, { name: 'metrics', value: 'Show room metrics.', inline: true }, { name: 'open', value: 'Open a room.', inline: true }, { name: 'esm-rooms', value: 'List ESM room modules available', inline: true }, { name: 'close', value: 'Close a room.', inline: true }, { name: 'reload', value: 'Reload the bot configuration.', inline: true }, { name: 'exit', value: 'Close the server.', inline: true }, { name: 'tokenlink', value: 'Haxball Headless Token page.', inline: true });
